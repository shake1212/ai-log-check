...
public class WebSocketController {
    ...
    public ResponseEntity<Map<String, String>> broadcastMessage(
        ...
        try {
            ...
            response.put("targetCount", String.valueOf(webSocketService.getConnectionCount()));
    ...
    public ResponseEntity<Map<String, String>> sendSystemInfo(
    ...
    public ResponseEntity<Map<String, String>> sendSystemError(
    ...
    public ResponseEntity<Map<String, String>> testConnection() {
        try {
            ...
            response.put("connectionCount", String.valueOf(webSocketService.getConnectionCount()));
            response.put("onlineUserCount", String.valueOf(webSocketService.getOnlineUserCount()));
